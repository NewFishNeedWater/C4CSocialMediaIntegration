package com.sap.integration.web.dingtalk;
...
import com.sap.integration.vo.requestVo.*;
...
import com.sap.integration.service.DingTalkService;
...
@RestController
public class C4CControllerForDingTalk {

    private static Logger logger = LoggerFactory.getLogger(C4CControllerForDingTalk.class);
